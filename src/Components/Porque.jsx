  ...
  return (
    <div className="bg-slate-200 my-10 p-5">
      <div className="w-10/12 flex-col  mx-auto">
        <h2 className="text-4xl my-8">Por que Nosotros ?</h2>
        ...
        <div className="flex flex-col md:flex-row  mx-auto justify-around  gap-6 my-8">
          ...
          <div className="flex flex-col gap-8 justify-center items-start">
            <h3 className="text-blue-700 text-5xl">Calidad</h3>
            <p className="text-2xl">
            ...
            <button className="text-3xl p-3 bg-blue-800 text-white rounded-3xl px-6 py-4 hover:bg-blue-600 m-auto">
              Contáctanos
            </button>
          </div>
        </div>
